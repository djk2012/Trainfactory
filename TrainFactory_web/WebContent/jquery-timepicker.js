 ...
 * @author  Ding Junkai
 *
 * Description Timepicker : First to choose the hour and finally choose the minute.
 *							Hour style:00-23
 *							Minute style:00-05-10...50-55
 */
...
(function ($) {
	$.hunterTimePicker = function (box, options) {
		...
		function buildHourTpl(){
			...
			hour_html += '<li class="Hunter-clean"><input type="button" class="Hunter-clean-btn" id="Hunter_clean_btn" value="clean up"></li>'
